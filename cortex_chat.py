...
class CortexChat:
    ...
    def _retrieve_response(self, query: str, role: str, limit=1) -> dict[str, any]:
    ...
    def chat(self, query: str, role: str) -> dict[str, any]:
        """
        ...
        """
        result = self._retrieve_response(query, role)
        return result
